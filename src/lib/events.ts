...
export const EVENTS: Record<string, EventConfig> = {
  tre2026: {
    ...
    endDate: '2026-07-05',
    description:
      '台湾・台北で開催される TRE（Taipei Red Expo）2026 に合わせ、出演する日本人女優の最新の公式X投稿と関連作品を VERITY がまとめる特設コーナー。各女優のプロフィール・最新作まで、そのままたどれる。随時更新中。',
    links: [
    ...
    aiSummary:
      '【TRE2026 出演女優まとめ（手動・暫定／随時更新中）】2026年7月3〜5日、台北南港展覧館2館で開催のTRE2026に河北彩花・石川澪・瀬戸環奈・純白彩永・福田ゆあら日本人女優が出演。本コーナーでは各女優の最新の公式X投稿と関連作品をまとめ、随時更新中です。※編集部による暫定要約です。将来はX投稿からの自動生成に対応予定。',
  },
}
