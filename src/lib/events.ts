...
export const EVENTS: Record<string, EventConfig> = {
  tre2026: {
    ...
    endDate: '2026-07-05',
    description:
      '台湾・台北で開催される TRE（Taipei Red Expo）2026 に合わせ、出演する日本人女優のX投稿と関連作品を VERITY がまとめる特設コーナー。会場の熱気を女優の生の声とともに追いながら、そのまま各女優のプロフィール・最新作までたどれる。',
    links: [
    ...
    aiSummary:
      '【本日のTRE2026まとめ（手動・暫定）】台北南港展覧館2館で開催中のTRE2026には河北彩花・桜空もも・石川澪・瀬戸環奈ら日本人女優が多数来場。会場でのファン交流やステージの様子が各女優のXで続々と共有されています。※本文は編集部による暫定要約です。将来はX投稿からの自動生成に対応予定。',
  },
}
