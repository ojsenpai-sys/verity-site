...
export const EVENTS: Record<string, EventConfig> = {
  tre2026: {
    ...
    endDate: '2026-07-05',
    description:
      '台湾・台北で開催される TRE（Taipei Red Expo）2026 に合わせ、出演する日本人女優の出演告知・TRE関連投稿と関連作品を VERITY がまとめる特設コーナー。各女優のプロフィール・最新作まで、そのままたどれる。会場からの最新投稿を随時更新中。',
    links: [
    ...
    aiSummary:
      '【TRE2026 出演女優まとめ（手動・暫定／随時更新中）】2026年7月3〜5日、台北南港展覧館2館で開催のTRE2026に河北彩花・桜空もも・石川澪・瀬戸環奈ら日本人女優が出演。本コーナーでは各女優の出演告知・TRE関連投稿と関連作品をまとめ、会場からの最新投稿を随時更新中です。※編集部による暫定要約です。将来はX投稿からの自動生成に対応予定。',
  },
}
